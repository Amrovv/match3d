...
/**
 * Publishes to the queue intake reads, as persistent messages naming their
 * event in the type property. RabbitTemplate is safe across threads.
 */
@Component
public final class RabbitPublisher implements EventPublisher {
    ...
    public void publish(Object event) {
        ...
        rabbit.send("", Queues.TO_INTAKE, new Message(EventJson.toBytes(event), properties));
    }
}
